...
function init() {
	...
	document.addEventListener("deviceready", setUpApp); //uncomment to launch on phonegap
	//setUpApp(); //uncomment to launch in browser
}
...
//check for device locatation suppoert
...
//if local storage exists list location data on the history page
...
//if local storage exists, list call data on the history page
function listCall(){
...
//pass location into local storage 
...
//shake works, get and call a random number from user contacts
